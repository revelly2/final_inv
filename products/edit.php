...
<div class="container mt-5">
    ...
    <form method="POST">
        ...
        <div class="mb-3">
            <label>Dosage</label>
            <input type="text" name="dosage" value="<?php echo $product['dosage']; ?>" class="form-control">
        </div>
        <div class="mb-3">
            <label>Buy Price</label>
            <input type="number" step="0.01" name="buy_price" value="<?php echo $product['buy_price']; ?>" class="form-control" required>
        </div>
        <div class="mb-3">
            <label>Sell Price</label>
            <input type="number" step="0.01" name="sell_price" value="<?php echo $product['sell_price']; ?>" class="form-control" required>
        </div>
        <div class="mb-3">
            <label>Stock</label>
        ...
        <div class="mb-3">
            <label>Barcode</label>
            <input type="text" name="barcode" value="<?php echo $product['product_barcode']; ?>" class="form-control" required>
        </div>
